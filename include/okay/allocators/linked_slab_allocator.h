...
template <
    size_t block_size_a = linked_slab_allocator::detail::default_block_size_a,
...
class linked_slab_allocator_t : public ok::allocator_t
{
  public:
    ...
    friend struct linked_slab_allocator::detail::
        start_with_one_pool_per_blocksize_t<block_size_a, block_size_b,
  ...
  private:
    array_t<linked_blockpool_allocator_t<>,
