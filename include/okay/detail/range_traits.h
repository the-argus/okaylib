#ifndef __OKAYLIB_DETAIL_RANGE_TRAITS_H__
#define __OKAYLIB_DETAIL_RANGE_TRAITS_H__
...
#define __OKAYLIB_ITERATOR_GETTER_FUNC_MEMBER_T(meta_type_name, func_name,     \
    ...
    struct meta_type_name<                                                     \
        iterable_t, cursor_t,                                                  \
        std::enable_if_t<                                                      \
            is_input_or_output_cursor_for_iterable_v<iterable_t, cursor_t> &&  \
            std::is_same_v<                                                    \
                ret_type,                                                      \
...
__OKAYLIB_ITERATOR_GETTER_FUNC_MEMBER_T(
    ...
    , sentinel_for_iterable_and_cursor_t<iterable_t __OK_COMMA cursor_t>)
...
#define __OKAYLIB_FREE_FUNCTION_ITERATOR_GETTER_IMPL(meta_type_name,           \
    ...
    inline constexpr auto func_name(const iterable_t& i)                       \
        -> decltype(meta_type_name<iterable_t, detail::default_cursor_type<    \
                                                   iterable_t>>::func_name(i)) \
    {                                                                          \
        return meta_type_name<iterable_t, detail::default_cursor_type<         \
                                              iterable_t>>::func_name(i);      \
    }
...
struct begin_fn_defaulted_t
{
    ...
    {
        static_assert(
            has_default_cursor_type_v<iterable_t>,
        ...
        using default_cursor_t = detail::default_cursor_type<iterable_t>;
...
template <typename cursor_t> struct begin_fn_t
{
    ...
    constexpr auto operator() [[nodiscard]] (const iterable_t& iterable) const
    {
        ...
        if constexpr (has_default_cursor_type_meta_t<iterable_t>::value &&
                      std::is_same_v<default_cursor_type<iterable_t>,
                                     cursor_t>) {
...
struct end_fn_defaulted_t
{
    ...
    constexpr auto operator() [[nodiscard]] (const iterable_t& iterable) const
    {
        ...
        using default_cursor_t = default_cursor_type<iterable_t>;
...
template <typename cursor_t> struct end_fn_t
{
    ...
    constexpr auto operator() [[nodiscard]] (const iterable_t& iterable) const
    {
        if constexpr (has_default_cursor_type_v<iterable_t> &&
                      std::is_same_v<default_cursor_type<iterable_t>,
                                     cursor_t>) {
