...
// template <typename _value_type, size_t size> class std_for_array
// {
//   public:
//     inline constexpr std_for_array(_value_type (&array)[size]) : inner(array)
//     {}

//     using value_type = _value_type;

//     using cursor_t = size_t; // arrays always use size-t
...
//         inline constexpr iterator(value_type (&_parent)[size], cursor_t
//         _cursor)
//             : parent(_parent), cursor(_cursor)
//         {
//         }
...
//       private:
//         value_type (&parent)[size];
//         cursor_t cursor;
//     };

//     inline constexpr iterator begin() OKAYLIB_NOEXCEPT
//     {
//         return iterator(inner, ok::begin(inner));
//     }

//     inline constexpr iterator end() OKAYLIB_NOEXCEPT
//     {
//         return iterator(inner, ok::end(inner));
//     }

//     value_type (&inner)[size];
// };
