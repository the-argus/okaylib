...
TEST_SUITE("ok::ranges_equal algorithm")
{
    ...
    {
        const ok::array_t test = {2, 4, 6, 8, 10};
        const ok::array_t test_diff_size = {2, 4, 6, 8, 10, 12};
        const ok::array_t test_diff_contents = {2, 4, 6, 8, 11};
    ...
    TEST_CASE("compare combinations of infinite/finite/sized")
    {
        ...
        {
            const ok::array_t test = {0, 1, 2, 3, 4, 5};
            const ok::array_t non_indices_test = {-1, 0, 1, 2, 3, 4, 5};
        ...
        constexpr ok::array_t finite_input = {0, 100, 1, 100, 2, 100, 3, 100};
        constexpr ok::array_t non_indices_finite_input = {0,   100, 1,   100, 2,
                                                          100, 3,   100, 5};
        ...
        {
            constexpr ok::array_t sized_indices = {0, 1, 2, 3};
